...
<body>
        ...
        if($data =="login_failed"){
            echo '<div class="container-fluid mt-1 ">
                        <div class="row alert alert-danger alert-dismissible fade show" role="alert">
                            <div class="col-lg-11 col-sm-10 ms-sm-5 ms-xs-1"><strong>Login Failed!</strong> Make sure your email or password is valid ...</div>
    ...
    <?php 
        if($data =="dberror"){
            echo '<div class="container-fluid mt-1 ">
                        <div class="row alert alert-danger alert-dismissible fade show" role="alert">
                            <div class="col-lg-11 col-sm-10 ms-sm-5 ms-xs-1"><strong>Login Failed!</strong> Please try again later ...</div>
                            <button type="button" class="col-lg-1 col-sm-1  order-12 regbtn" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
    ...
    <div class="container-fluid mt-5 domin">
        <div class="row h-50">
            <div class="col-md-4 col-lg-6 col-sm-9 col-9 m-auto bgform">
                ...
                <form action="https://localhost/MVC/home/logval" method="post" enctype="multipart/form-data">
                    ...
                    <button id = "regist" type="submit" class="btn btn-primary  mb-4 ">Login</button>
                </form>
